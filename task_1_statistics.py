...
with open('data/task_1/inputfilenames.json', 'r') as f:
    inputfilenames = json.loads(f.read())

for inputfilename in inputfilenames:
    inputfile_path = os.path.join('data', 'task_1', inputfilename)
    ...
    outputfile_path = os.path.join('data', 'task_1', 'results', 'statfile_' + inputfilename.split('_stats')[0][-2:] + '.txt')
    ...
    outputtable_path = os.path.join('data', 'task_1', 'results', 'stattable_' + inputfilename.split('_stats')[0][-2:] + '.html')
